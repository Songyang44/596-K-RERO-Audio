...
const BinaryResourceStore_1 = require("./document/resource/binaryResource/BinaryResourceStore");
const DataResourceStore_1 = require("./document/resource/dataResource/DataResourceStore");
const ContainerResourceStore_1 = require("./document/resource/dataResource/containerResource/ContainerResourceStore");
const AccessRulesStore_1 = require("./document/accessRules/AccessRulesStore");
const LdoProvider = ({ dataset, fetch, onDocumentError, children }) => {
    ...
    const storeDependencies = (0, react_1.useMemo)(() => {
        ...
        const binaryResourceStore = new BinaryResourceStore_1.BinaryResourceStore(dependencies);
        const dataResourceStore = new DataResourceStore_1.DataResourceStore(dependencies);
        const containerResourceStore = new ContainerResourceStore_1.ContainerResourceStore(dependencies);
        const accessRulesStore = new AccessRulesStore_1.AccessRulesStore(dependencies);
