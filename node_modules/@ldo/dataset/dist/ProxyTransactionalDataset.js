...
const ExtendedDataset_1 = __importDefault(require("./ExtendedDataset"));
class ProxyTransactionalDataset extends ExtendedDataset_1.default {
    ...
    updateDatasetChanges(changes) {
        ...
        if (changes.removed) {
            if (this.datasetChanges.removed) {
                ...
                this.datasetChanges.removed = this.datasetFactory.dataset(changes.removed);
            }
        }
        if (this.datasetChanges.added && this.datasetChanges.removed) {
            const changesIntersection = this.datasetChanges.added.intersection(this.datasetChanges.removed);
