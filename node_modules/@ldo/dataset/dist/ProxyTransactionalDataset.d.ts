...
import type { BulkEditableDataset, DatasetChanges, TransactionalDataset } from "./types";
import ExtendedDataset from "./ExtendedDataset";
export default class ProxyTransactionalDataset<InAndOutQuad extends BaseQuad = BaseQuad> extends ExtendedDataset<InAndOutQuad> implements BulkEditableDataset<InAndOutQuad>, TransactionalDataset<InAndOutQuad> {
    private parentDataset;
    private datasetFactory;
    private datasetChanges;
    private committedDatasetChanges?;
    constructor(parentDataset: Dataset<InAndOutQuad, InAndOutQuad>, datasetFactory: DatasetFactory<InAndOutQuad, InAndOutQuad>);
